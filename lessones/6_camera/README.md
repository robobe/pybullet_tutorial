...
[Camera Intrinsics and Extrinsics - 5 Minutes with Cyrill ](https://youtu.be/ND2fa08vxkY)

## Simple demo the explain in the code comments
...
> [!NOTE]
> ## Exercise 
> Mount the camera on the racer car
> Add world with line for car to follow
> control the car movement using the keyboard
> [check](code/racer_car_mount_camera.py) for init world with line and camera mount on the car
